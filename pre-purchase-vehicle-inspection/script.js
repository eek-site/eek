...
const services = {
  ...
  comprehensive: {
    ...
    features: [
      ...
      'Executive Summary with price guide',
      'BUY/DON\'T BUY/Proceed with Caution recommendation',
      '44-point pre-purchase inspection checklist',
      'Maintenance requirements analysis',
      'Recalls & safety notices section',
      'Complete CarJam data summary (section by section)',
      'Vehicle valuation at top of report',
