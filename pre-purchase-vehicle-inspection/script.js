...
const services = {
  ...
  comprehensive: {
    ...
    features: [
      ...
      'Professional valuation (NZ$25,000-$27,000)',
      '25-page detailed report',
      'CarJam database analysis',
      'Insurance write-off history check',
      'Stolen vehicle verification',
      'Finance owing status',
      'Complete ownership history (2 owners)',
      'WOF inspection history analysis',
      'Odometer verification & tampering check',
      'Road User Charges compliance status',
      'Recall status & safety notices',
      'Service history & maintenance records',
      'Previous accident damage assessment',
      'Modification compliance verification',
      'Warranty status & remaining coverage',
      'Market value comparison & negotiation points',
      'Running costs analysis ($8,414/year)',
      'Safety rating & feature verification',
      'Model-specific known issues analysis',
      'Immediate cost estimates ($1,162-$2,090)',
