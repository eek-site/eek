...
export default function NotificationBell({ portalCode }: NotificationBellProps) {
  ...
  return (
    ...
    >
      ...
      <span className="hidden sm:inline">
        {loading ? 'Loading...' : showSuccess ? 'Enabled!' : isSubscribed ? 'Notifications On' : 'Enable Notifications'}
      </span>
    </button>
  )
}
