...
export const metadata: Metadata = {
  title: 'Accident Towing NZ | 24/7 Crash Recovery | Eek Mechanical',
  description: '24/7 accident towing and crash recovery across New Zealand. Fast response, insurance coordination, panel beater delivery. Call 0800 769 000.',
  keywords: 'accident towing, crash recovery, accident recovery, collision towing, NZ accident towing',
}
  ...
  return (
    <main className="min-h-screen bg-black text-white">
      ...
      <section className="pt-32 pb-16 px-6">
        <div className="max-w-4xl mx-auto">
          <div className="flex items-center gap-2 text-zinc-500 text-sm mb-4">
            ...
            <span>/</span>
            <span className="text-white">Accident Towing</span>
          </div>
          ...
          <p className="text-xl text-zinc-400 mb-8">
            After an accident, you need quick, professional recovery. We work with police, insurance companies, and panel beaters to get your vehicle where it needs to go.
          </p>
      ...
      <section className="py-16 px-6 bg-zinc-900/50">
        <div className="max-w-4xl mx-auto">
          <h2 className="font-display text-2xl md:text-3xl font-bold mb-8">Accident Towing by City</h2>
      ...
      <section className="py-16 px-6">
        <div className="max-w-2xl mx-auto text-center">
          <h2 className="font-display text-3xl font-bold mb-4">Been in an accident?</h2>
          <a
            href="tel:0800769000"
