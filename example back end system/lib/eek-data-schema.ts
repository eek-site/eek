/**
 * Eek Mobile Mechanical Data Schema
...
// Issue types - why the vehicle needs service
...
// Service purpose - what service is needed
...
export const TOW_PURPOSES = SERVICE_PURPOSES
export type TowPurpose = ServicePurpose
...
export interface CustomerBookingData {
  ...
  towPurpose?: TowPurpose  // Legacy alias
  description?: string
...
// Webhook payload for external integrations (Power Automate, etc.)
